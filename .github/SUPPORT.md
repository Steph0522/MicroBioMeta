...
Thank you for using `MicroBioMeta`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/MicroBioMeta`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/MicroBioMeta),
...
[search issues and pull requests](https://github.com/Steph0522/MicroBioMeta/issues)
