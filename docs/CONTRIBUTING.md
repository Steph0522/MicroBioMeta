...
This outlines how to propose a change to MicroBioMeta. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("Steph0522/MicroBioMeta", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://steph0522.github.io/MicroBioMeta/CODE_OF_CONDUCT.md).
